...
// Strings from LangUtils
  rsSystemDefault = '&System-Standard'; // "&" ist erforderlich damit dieser Eintrag immer als erster angezeigt wird
...
// Misc.
  ...
  rsUnknown = '<Unbekannt>';
  rsAnyKey = 'Drücken Sie eine beliebige Taste, um fortzufahren ...';
