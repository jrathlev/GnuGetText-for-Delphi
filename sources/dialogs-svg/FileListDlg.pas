...
type
  TFileListDialog = class(TForm)
    ...
    btSaveAs: TJrSpeedButton;
    DeleteBtn: TJrSpeedButton;
    DownBtn: TJrSpeedButton;
    InsertBtn: TJrSpeedButton;
    UpBtn: TJrSpeedButton;
...
//          = true  : FName is a file name from where to load the file list
...
uses GnuGetText, Vcl.FileCtrl, WinUtils, ImageLoader;
...
procedure TFileListDialog.FormAfterMonitorDpiChanged(Sender: TObject; OldDPI,
  NewDPI: Integer);
begin
