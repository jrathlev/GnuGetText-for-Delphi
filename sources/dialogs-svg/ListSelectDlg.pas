...
type
  ...
  public
    ...
    procedure ShowList (const APos : TPoint; AHeight : integer = 0);
...
begin
  FOnSelect:=nil; FWidth:=0; PixelsPerInchOnCreate:=PixelsPerInch;
//  with ListSelectDialog do ItemHeight:=SizeScale(defItemHeight,PixelsPerInch,self);
  end;

procedure TListSelectDialog.FormAfterMonitorDpiChanged(Sender: TObject; OldDPI,
  NewDPI: Integer);
begin
//  with ListSelectDialog do ItemHeight:=SizeScale(defItemHeight,PixelsPerInchOnCreate,self);
  end;
...
begin
   Height:=SizeScale(defItemHeight,PixelsPerInchOnCreate,self);;
   end;

procedure TListSelectDialog.ShowList (const APos : TPoint; AHeight : integer);
var
  i,j,w,h : integer;
begin
