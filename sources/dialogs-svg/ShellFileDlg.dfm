object ShellFileDialog: TShellFileDialog
  Left = 460
  Top = 131
  Caption = 'Dialog'
  ClientHeight = 421
  ...
  object pnlTop: TPanel
    ...
    object spbLast: TJrSpeedButton
      Left = 429
      Top = 5
      Width = 31
      Height = 31
      Hint = 'Go to last folder displayed'
      Anchors = [akTop, akRight]
      Flat = True
      Images = SVGImgLst24
      ImageIndex = 9
  ...
  object pnlBottom: TPanel
    ...
    object cbSelectedFile: TComboBox
      Left = 90
      Top = 15
      Width = 487
      Height = 21
  ...
  object SVGImgColl: TSVGIconImageCollection
    SVGIconItems = <
      ...
      item
        IconName = 'arrow-left-blue'
        SVGText = 
          '<svg height="48" viewBox="0 0 48 48" width="48" xmlns="http://ww' +
          'w.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><l' +
          'inearGradient id="a" gradientUnits="userSpaceOnUse" x1="14.77632' +
          '9" x2="32.271755" y1="37.151104" y2="6.848136"><stop offset="0" ' +
          'stop-color="#006bbf"/><stop offset="1" stop-color="#4db0f0"/></l' +
          'inearGradient><g stroke-miterlimit="10" transform="matrix(0 -1.0' +
          '002613 1.0002613 0 1.994631 47.530191)"><path d="m14.519136 38.5' +
          ' 18.005029-.0039v-12.991632l7.995366-.0078-17.144722-19.9974545-' +
          '16.8462505 19.9980705 7.9958815.0038z" fill="url(#a)" fill-rule=' +
          '"evenodd" stroke="#0f4e81" stroke-linecap="round" stroke-linejoi' +
          'n="round"/><path d="m15.520704 37.496094 16.001405.003906v-12.99' +
          '295l6.816811-.015625-14.954276-17.4525854-14.7065267 17.4569424 ' +
          '6.8399007.0052z" fill="none" opacity=".481283" stroke="#eaeaea"/' +
          '></g></svg>'
      end>
    Left = 385
    Top = 140
