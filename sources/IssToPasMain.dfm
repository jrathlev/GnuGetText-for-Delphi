object frmMain: TfrmMain
  ...
  object Label2: TLabel
    ...
    Width = 108
    Height = 13
    Caption = 'Extract from iss script:'
  end
  ...
  object laTitle: TLabel
    ...
    AutoSize = False
    Caption = 
      'Convert CustomMessages from Inno Setup script to Pascal resource' +
      ' strings'
    Color = clHotLight
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
  ...
  object bbIssFile: TJrSpeedButton
    Left = 475
    Top = 48
    Width = 31
    Height = 31
    Hint = 'Select iss file'
  ...
  object bbCopyName: TJrSpeedButton
    Left = 475
    Top = 93
    Width = 31
    Height = 31
  ...
  object bbSave: TJrButton
    ...
    Width = 236
    Height = 36
    Hint = 'Extract strings from InnoSetup script and save'
