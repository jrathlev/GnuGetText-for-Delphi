object frmMain: TfrmMain
  ...
  object laTitle: TLabel
    ...
    AutoSize = False
    Caption = 'Convert po strings to CustomMessages used in Inno Setup'
    Color = clHotLight
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object bbPoFile: TJrSpeedButton
    Left = 475
    Top = 48
    Width = 31
    Height = 31
  ...
  object bbConvert: TJrButton
    Left = 150
    Top = 135
    Width = 236
    Height = 36
    Hint = 'Convert po strings and save'
